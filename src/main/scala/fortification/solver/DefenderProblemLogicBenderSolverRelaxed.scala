...
class DefenderProblemLogicBenderSolverRelaxed(val instance: DefenderProblemInstance, val instructor: SolverInstructor) extends timer {
  import instance._
...
object DefenderProblemLogicBenderSolverRelaxed {
  def main(args: Array[String]): Unit = {
    ...
    Console.withOut(outCapture) {
      ...
      val solver = new DefenderProblemLogicBenderSolverRelaxed(defenderInstance, instructor)
